    ...
    <div class="card shadow-sm rounded-3">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          @if ((auth()->user()->can('edit_society') && $model->status == 'active') || (isset($property) && auth()->user()->can('edit_property')))
        ...
        @php
          ...
          $mediaFiles = $model->attachments->filter(function ($attachment) {
        ...
        @else
          ...
          <div class="text-center py-5">
            ...
            @if (auth()->user()->can('edit_society') && $model->status == 'active')
